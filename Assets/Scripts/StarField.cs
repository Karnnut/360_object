...
public class StarField : MonoBehaviour {
  ...
  private void OnValidate() {
    ...
    // A constellation is a tuple of the stars and the lines that join then.
  public readonly List<(int[], int[])> constellations = new(){
    //Orion
      (new int[] { 1948,  1903, 1852, 2004, 1713, 2061, 1798, 1907,  2124, 
                  2199, 2135, 2047, 2159, 1543, 1544, 1578, 1552, 1567},
      ...
      // Merceros
      (new int[] { 3047, 3188, 2714, 2356, 2227, 2506, 2298, 2385, 2456, 2484},
      new int[] { 3047, 3188, 3188, 2714, 2714, 2356, 2356, 2227, 2714, 2506,
                  2506, 2298, 2298, 2385, 2456, 2385, 2506, 2385}),
    
      //Gemini
      (new int[] {2890, 2891, 2990, 2421, 2777, 2473, 2650, 2216, 2895,
                2343, 2484, 2286, 2134, 2763, 2697, 2540, 2821, 2905, 2985},
      new int[] { 2890, 2697, 2990, 2905, 2697, 2473, 2906, 2777, 2650,
                2658, 2421, 2473, 2286, 2286, 2216, 2473, 2343, 2216, 2134,
                2763, 2484, 2763, 2777, 2697, 2540, 2697, 2821, 2821, 2905, 2905, 2985}),

      //Cancer
      (new int[] {3475, 3449, 3461, 3572, 3249},
      new int[] {3475, 3449, 3449, 3461, 3572, 3461, 3249}),

      //Leo
      (new int[] {3982, 4534, 4057, 4357, 3873, 4031, 4359, 3975, 4399, 4386, 3905, 3773, 3731},
      new int[] {4534, 4357, 4534, 4359, 4357,  4359, 4357, 4057, 4031,
      4057, 3978, 3975, 3982, 3975, 4359, 4359, 4399, 4399, 4386,
      ...
      new int[] {3569, 3594, 3594, 3775, 3888, 3888, 3323, 3323, 3757,
      3757, 3888, 3757, 4301, 3295, 4295, 3888, 4295, 4554,
  ...
  void CreateConstellation(int index) {
    ...
    // Create a line renderer for each line in the constellation
    for (int i = 0; i < lines.Length; i += 2) {

      // Parent the line to our constellation object so we can delete them all later
      GameObject line = new("Line");
      line.transform.parent = constellationHolder.transform;
      // Default to white and width 1 which works for us.
      ...
      // Offset them so they don't occlude the stars, 3 chosen through trial and error.
  ...
  void RemoveConstellation(int index) {
    ...
    //Remove from our dectionary as it's now off.
